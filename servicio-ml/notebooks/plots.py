...
def plot_feature_correlation(X, save_path=None):
    """
    Plots the correlation matrix of the features in the dataframe X.
    ...
    # Genera un mapa de calor usando la matriz de correlación
    ...
    # Guarda el gráfico si save_path es especificado
    if save_path:
        plt.savefig(save_path, format="png", dpi=600)

    # Prevemos que Matplotlib muestre el gráfico cada vez que llamamos a la función
    plt.close(fig)
